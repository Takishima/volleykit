...
export function OCRPanel({
  ...
  const [processedResult, setProcessedResult] = useState<ParsedGameSheet | null>(null)
  ...
  const initializeSelection = useCallback((results: PlayerComparisonResult[]) => {
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {step === 'results' && (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-success-600 dark:text-success-400">
                ...
                <span className="font-medium">{t('validation.ocr.scanComplete')}</span>
              </div>
          ...
          {step === 'error' && (
            <div className="py-8 flex flex-col items-center justify-center" role="alert">
              <AlertCircle className="w-12 h-12 text-danger-500 mb-4" aria-hidden="true" />
