...
describe('TravelTimeFilterToggle', () => {
  it('renders with unchecked state', () => {
    ...
    render(<TravelTimeFilterToggle checked={false} onChange={onChange} maxTravelTimeMinutes={60} />)
  ...
  it('renders with checked state', () => {
    ...
    render(<TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={60} />)
  ...
  it('displays formatted time value when checked (minutes only)', () => {
    ...
    render(<TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={45} />)
  ...
  it('displays formatted time value when checked (hours)', () => {
    ...
    render(<TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={120} />)
  ...
  it('displays formatted time value when checked (hours and minutes)', () => {
    ...
    render(<TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={90} />)
  ...
  it('shows train icon when checked', () => {
    ...
    const { container } = render(
      <TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={60} />
    )
  ...
  it('handles edge case of zero minutes', () => {
    ...
    render(<TravelTimeFilterToggle checked={true} onChange={onChange} maxTravelTimeMinutes={0} />)
