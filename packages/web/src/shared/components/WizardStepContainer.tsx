...
export function WizardStepContainer({
  ...
  const { containerRef, translateX, isDragging, containerWidth, setTranslateX, handlers } =
    useSwipeGesture({
      ...
      onDragEnd: (currentTranslateX, width) => {
        ...
        const canNavigate = (goingNext && canSwipeNext) || (!goingNext && canSwipePrevious)
  ...
  return (
    <div ref={containerRef} className="relative overflow-hidden" {...handlers}>
      <div
        style={{
