...
describe('TourTooltip', () => {
  ...
  it('calls onPrevious when previous button is clicked', async () => {
    ...
    render(<TourTooltip {...defaultProps} isFirstStep={false} onPrevious={onPrevious} />)
  ...
  it('shows previous button on non-first steps', () => {
    render(<TourTooltip {...defaultProps} isFirstStep={false} currentStep={1} />)
  ...
  it('highlights current step dot', () => {
    ...
    const dots = screen
      .getAllByRole('generic')
      .filter((el) => el.className.includes('rounded-full') && el.className.includes('w-2'))
  ...
  it('does not render previous button when onPrevious is undefined', () => {
    render(<TourTooltip {...defaultProps} isFirstStep={false} onPrevious={undefined} />)
