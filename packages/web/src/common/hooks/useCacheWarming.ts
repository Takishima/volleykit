...
import { setMetadata } from '@/common/services/offline'
import { useAuthStore } from '@/common/stores/auth'
import { useDemoStore } from '@/common/stores/demo'
import { MS_PER_MINUTE, MS_PER_HOUR } from '@/common/utils/constants'
...
async function warmCache(
  ...
  const lastWarmed = await import('@/common/services/offline').then((m) =>
