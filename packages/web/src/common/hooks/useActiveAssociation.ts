 ...
 *
 * Promoted from features/auth/ to shared/ because it is used by 10+ files
 * across assignments, exchanges, settings, and shared hooks/components.
 */

import { useShallow } from 'zustand/react/shallow'

import { useAuthStore, CALENDAR_ASSOCIATION } from '@/common/stores/auth'
