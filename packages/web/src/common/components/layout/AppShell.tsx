...
import { TourModeBanner } from '@/common/components/tour/TourModeBanner'
import { features } from '@/common/config/features'
import { prefetchAllTabData } from '@/common/hooks/usePrefetchTabData'
...
const DebugPanel = lazy(() =>
  import('@/common/components/debug/DebugPanel').then((m) => ({
