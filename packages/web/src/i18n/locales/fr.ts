...
const fr: Translations = {
  tour: {
    ...
    assignments: {
      ...
      swipeExchange: {
        ...
        description: 'Glissez à droite pour proposer cette désignation à la bourse.',
      },
      tapDetails: {
        title: 'Appuyez pour détails',
        description: 'Appuyez sur une carte pour plus de détails.',
      },
    },
    compensations: {
      overview: {
        title: 'Vos indemnités',
        description: 'Vos frais de match et de déplacement.',
      },
      swipeEdit: {
        title: 'Glissez à gauche',
        description: 'Glissez à gauche pour modifier ou télécharger le PDF.',
      },
      tapDetails: {
        title: 'Appuyez pour détails',
        description: 'Appuyez sur une carte pour le détail complet.',
      },
    },
    exchange: {
      browse: {
      ...
      apply: {
        ...
        description: 'Glissez à gauche pour postuler à cet échange.',
      },
      filters: {
    ...
    settings: {
      ...
      homeLocation: {
        title: 'Emplacement',
        description: 'Définissez votre position pour filtrer par distance et temps de trajet.',
      },
      arrivalTime: {
        title: "Heure d'arrivée",
        description: 'Minutes avant le match pour arriver.',
      },
      complete: {
        title: 'Visite terminée !',
        description: 'Vous pouvez recommencer les visites à tout moment dans les paramètres.',
      },
      tourSection: {
  ...
  common: {
    ...
    crossAssociationGameToday: "Match aujourd'hui chez {association}",
    crossAssociationGameTomorrow: 'Match demain chez {association}',
    crossAssociationSwitchTo: 'Passer à {association}',
    vs: 'vs',
    unknown: 'Inconnu',
    unknownDate: 'Date ?',
    currencyChf: 'CHF',
  ...
  auth: {
    ...
    calendarModeHint:
      'Trouvez votre URL de calendrier dans VolleyManager sur la page Mes désignations',
  ...
  calendarError: {
    ...
    networkMessage:
      'Impossible de charger votre calendrier. Veuillez vérifier votre connexion internet et réessayer.',
    invalidCodeMessage:
      'Le code de calendrier est invalide ou a expiré. Veuillez vous connecter avec un nouveau code.',
    parseErrorMessage:
      "Certaines données du calendrier n'ont pas pu être lues. Affichage des désignations disponibles.",
    ok: 'OK',
  ...
  compensations: {
    ...
    pdfNotAvailableDemo: 'Les téléchargements PDF ne sont pas disponibles en mode démo',
    pdfDownloadFailed: 'Échec du téléchargement du PDF. Veuillez réessayer plus tard.',
  ...
  exchange: {
    ...
    removeConfirm: 'Êtes-vous sûr de vouloir retirer cette désignation de la bourse?',
    ...
    exchangesNotTakeableOne:
      'Un échange est masqué : l’association ne vous autorise pas à le reprendre.',
    ...
    noApplicationsDescription: "Vous n'avez pas encore proposé de matchs à l'échange.",
  ...
  settings: {
    ...
    homeLocation: {
      ...
      description: 'Définissez votre emplacement pour filtrer les échanges par distance.',
    ...
    help: {
      ...
      description: 'Apprenez à utiliser VolleyKit avec des guides et conseils détaillés.',
    ...
    safeModeWarningPoint1: 'volleymanager.volleyball.ch est la seule source faisant autorité',
    safeModeWarningPoint2: 'Vérifiez toujours vos modifications sur le site officiel VolleyManager',
    safeModeWarningPoint3: 'VolleyKit décline toute responsabilité pour les erreurs éventuelles',
  ...
  pdf: {
    ...
    wizard: {
      ...
      nonConformant: {
        ...
        previewTitle: 'Vérifier le rapport',
        confirmAndSign: 'Confirmer & Signer',
        signaturesTitle: 'Signatures',
        signaturesProgress: '{count} sur {total}',
        firstRefereeLabel: '1er Arbitre',
        secondRefereeLabel: '2e Arbitre',
        ...
        stepComment: 'Commentaire',
        stepPreview: 'Aperçu',
        stepSign: 'Signatures',
      },

      sections: {
        fieldAndLines: 'Terrain de jeu et lignes',
        warmUpArea: "Aire d'échauffement",
        netEquipment: 'Filets et antennes',
        refereeChair: "Chaise d'arbitre",
        manometer: 'Manomètre',
        measuringRod: 'Toise',
        lineFlags: 'Drapeaux juges de ligne',
        buzzer: 'Buzzer',
        eScoresheet: 'eScoresheet',
        tablets: 'Tablets',
        scoreboard: "Tableau d'affichage électronique",
        balls: 'Ballons',
        ballRetrievers: 'Ramasseurs de balles',
        quickMoppers: 'Quick moppers',
        hallSpeaker: 'Speaker',
        dressHome: 'Tenue équipe recevante',
        dressAway: 'Tenue équipe visiteurs',
        miscellaneous: 'Divers',
        numberPlates: 'Plaques numérotées',
      },

      subItems: {
        boundaryLines: 'Lignes de délimitation/médiane (5 cm, contraste)',
        attackLine: "Ligne d'attaque plus prolongation",
        freeZone: 'Zone libre',
        warmUpArea: "Aire d'échauffement (~300×300 cm)",
        antennas: '2 antennes + antennes de réserve',
        netTopBand: 'Bande supérieure du filet 7 cm blanc',
        netBottomBand: 'Bande inférieure du filet 5 cm blanc',
        reserveNet: 'Filet de réserve',
        postsNoWire: 'Poteaux sans câble de tension',
        postsPadding: 'Poteaux avec rembourrage',
        tabletMount: 'Fixations pour tablets',
        netHeight: 'Hauteur du filet correcte',
        refereeChair: "Chaise d'arbitre (réglable en hauteur)",
        manometer: 'Manomètre fonctionnel',
        measuringRod: 'Toise',
        lineFlags: '2 drapeaux pour juges de ligne',
        buzzer: 'Buzzer fonctionnel et audible',
        eScorerOnTime: "eScorer à l'heure dans la salle",
        reserveLaptop: 'Laptop de réserve (match chargé)',
        usbStick: 'Clé USB (min. 1 Go)',
        reserveMatchSheet: 'Feuille de match de réserve (papier)',
        refereeTablets: 'Tablets avec application arbitre',
        benchTablets: 'Tablets avec application banc',
        matchKit: 'Tenue de match',
        scoreboard: "Tableau d'affichage électronique présent",
        scoreboardFunction: "Tableau d'affichage fonctionnel",
        ballCount: 'Nombre de ballons suffisant',
        ballCondition: 'État des ballons',
        ballRetrievers: 'Ramasseurs de balles présents',
        ballRetrieversException: 'Ramasseurs de balles (salle avec dérogation)',
        quickMoppers: 'Quick moppers présents',
        hallSpeaker: 'Speaker présent',
        dressColor: 'Couleur de tenue conforme',
        advertisingOnUniform: 'Publicité sur la tenue',
        liberoDress: 'Tenue du libéro',
        miscItem1: 'Divers 1',
        miscItem2: 'Divers 2',
        numberPlatesHome: 'Plaques numérotées équipe recevante',
        numberPlatesAway: 'Plaques numérotées équipe visiteurs',
        numberPlates: 'Plaques numérotées (2 jeux, n° 1–20)',
        practiseBalls: "Ballons d'échauffement",
        matchBalls: 'Ballons de match',
        matchBallsException: 'Ballons de match (salle avec dérogation)',
      },
    },
  },
  errorBoundary: {
    ...
    modal: {
      ...
      errorDescription: "Une erreur s'est produite avec cette action. Veuillez réessayer.",
      closeModal: 'Fermer',
    },
  },
  validation: {
    ...
    homeRosterPlaceholder: "La vérification de l'effectif domicile sera disponible ici.",
    awayRosterPlaceholder: "La vérification de l'effectif visiteur sera disponible ici.",
    scorerPlaceholder: "L'identification du marqueur sera disponible ici.",
    scoresheetPlaceholder: 'Le téléchargement de la feuille de match sera disponible ici.',
    ...
    state: {
      ...
      unsavedChangesMessage: 'Vous avez des modifications non enregistrées. Que voulez-vous faire?',
      ...
      markAllStepsTooltip: 'Marquez toutes les étapes requises comme vérifiées pour terminer',
    },
    rosterWarning: {
    ...
    ocr: {
      ...
      scanScoresheetDescription:
        'Prenez une photo ou sélectionnez une image de la feuille de match pour remplir automatiquement les noms des joueurs',
      takePhoto: 'Prendre une photo',
      ...
      errors: {
        ...
        processingFailed:
          "Échec du traitement de l'image. Veuillez réessayer avec une photo plus nette.",
        noTextFound:
          "Aucun texte détecté dans l'image. Assurez-vous que la feuille de match est bien visible.",
        imageTooLarge:
          "L'image est trop volumineuse. Veuillez utiliser une image plus petite (max 10 Mo).",
      },
      rawData: {
  ...
  easterEggs: {
    ac3: {
      ...
      message:
        "Un troisième entraîneur adjoint ? Quelqu'un va en enfer des arbitres pour cette paperasse !",
    },
    multipleDoctors: {
      title: 'Conférence médicale !',
      message:
        "Plusieurs médecins sur le banc ? Soit cette équipe s'attend à un match difficile, soit c'est une conférence médicale !",
    },
    dismiss: 'Compris !',
  },
}
