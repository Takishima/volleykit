...
const en: Translations = {
  ...
  common: {
    ...
    crossAssociationGameToday: 'Game today in {association}',
    crossAssociationGameTomorrow: 'Game tomorrow in {association}',
    crossAssociationSwitchTo: 'Switch to {association}',
    vs: 'vs',
    unknown: 'Unknown',
    unknownDate: 'Date?',
    currencyChf: 'CHF',
  ...
  settings: {
    ...
    transport: {
      ...
      travelMode: 'Route calculation',
      travelModeDescription: 'How travel times to the sports hall are calculated',
      travelModePublicTransport: 'Public transport (door to door)',
      travelModeEbikeTrain: 'E-bike + train (cycle to and from the station)',
      maxBikeDistance: 'Maximum cycling distance',
      maxBikeDistanceDescription: 'Longer routes fall back to public transport',
  ...
  pdf: {
    ...
    wizard: {
      ...
      nonConformant: {
        ...
        previewTitle: 'Review report',
        confirmAndSign: 'Confirm & Sign',
        signaturesTitle: 'Signatures',
        signaturesProgress: '{count} of {total}',
        firstRefereeLabel: '1st Referee',
        secondRefereeLabel: '2nd Referee',
      ...
      sections: {
        fieldAndLines: 'Playing field and lines',
        warmUpArea: 'Warm-up area',
        netEquipment: 'Net equipment with antennas',
        refereeChair: 'Referee chair',
        manometer: 'Manometer',
        measuringRod: 'Measuring rod',
        lineFlags: 'Line judge flags',
        buzzer: 'Buzzer',
        eScoresheet: 'eScoresheet',
        tablets: 'Tablets',
        scoreboard: 'Electronic scoreboard',
        balls: 'Balls',
        ballRetrievers: 'Ball retrievers',
        quickMoppers: 'Quick moppers',
        hallSpeaker: 'Hall speaker',
        dressHome: 'Home team uniform',
        dressAway: 'Away team uniform',
        miscellaneous: 'Miscellaneous',
        numberPlates: 'Number plates',
      },

      subItems: {
        boundaryLines: 'Boundary/center line (5 cm, contrast)',
        attackLine: 'Attack line plus extension',
        freeZone: 'Free zone',
        warmUpArea: 'Warm-up area (~300×300 cm)',
        antennas: '2 antennas + reserve antennas',
        netTopBand: 'Net top band 7 cm white',
        netBottomBand: 'Net bottom band 5 cm white',
        reserveNet: 'Reserve net',
        postsNoWire: 'Posts without tension wire',
        postsPadding: 'Posts with padding',
        tabletMount: 'Tablet mounting options',
        netHeight: 'Net height correct',
        refereeChair: 'Referee chair (height-adjustable)',
        manometer: 'Functioning manometer',
        measuringRod: 'Measuring rod',
        lineFlags: '2 flags for line judges',
        buzzer: 'Buzzer functioning and audible',
        eScorerOnTime: 'eScorer on time in the hall',
        reserveLaptop: 'Reserve laptop (game loaded)',
        usbStick: 'USB stick (min. 1 GB)',
        reserveMatchSheet: 'Reserve match sheet (paper)',
        refereeTablets: 'Tablets with Referee Application',
        benchTablets: 'Tablets with Bench Application',
        matchKit: 'Match kit',
        scoreboard: 'Electronic scoreboard present',
        scoreboardFunction: 'Scoreboard functioning',
        ballCount: 'Sufficient number of balls',
        ballCondition: 'Ball condition',
        ballRetrievers: 'Ball retrievers present',
        ballRetrieversException: 'Ball retrievers (exception hall)',
        quickMoppers: 'Quick moppers present',
        hallSpeaker: 'Hall speaker present',
        dressColor: 'Uniform color compliant',
        advertisingOnUniform: 'Advertising on uniform',
        liberoDress: 'Libero uniform',
        miscItem1: 'Other 1',
        miscItem2: 'Other 2',
        numberPlatesHome: 'Number plates home team',
        numberPlatesAway: 'Number plates away team',
        numberPlates: 'Number plates (2 sets, Nr. 1–20)',
        practiseBalls: 'Practice balls',
        matchBalls: 'Match balls',
        matchBallsException: 'Match balls (exception hall)',
      },
    },
  },
  errorBoundary: {
