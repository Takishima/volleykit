...
const en: Translations = {
  ...
  absences: {
    ...
    errorLoading: 'Failed to load absences',
    noUpcomingTitle: 'No upcoming absences',
    noPastTitle: 'No past absences',
    emptyDescription: 'Blocked dates for the selected association appear here.',
    noReason: 'No reason given',
    truncatedNote: 'The server did not return the full list ({total} absences in total).',
    readOnly: 'Locked',
    readOnlyTooltip: 'This absence was set by the association and cannot be edited.',
    entryLabel: 'Absence',
    associationScopeHint: 'Absences apply to the currently selected association.',
    calendarModeTitle: 'Absences unavailable',
    calendarModeDescription: 'Calendar mode has no login, so absences cannot be loaded.',
  },
  assignments: {
    title: 'Assignments',
    upcoming: 'Upcoming',
