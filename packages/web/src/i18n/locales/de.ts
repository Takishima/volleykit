...
const de: Translations = {
  tour: {
    ...
    assignments: {
      ...
      swipeExchange: {
        ...
        description: 'Nach rechts wischen, um den Einsatz zur Börse anzubieten.',
      },
      tapDetails: {
        title: 'Antippen für Details',
        description: 'Tippen Sie auf eine Karte für mehr Details.',
      },
    },
    compensations: {
      overview: {
        title: 'Ihre Entschädigungen',
        description: 'Ihre Spielgebühren und Reisekosten.',
      },
      swipeEdit: {
        title: 'Nach links wischen',
        description: 'Nach links wischen zum Bearbeiten oder PDF herunterladen.',
      },
      tapDetails: {
        title: 'Antippen für Details',
        description: 'Tippen Sie auf eine Karte für die vollständige Aufschlüsselung.',
      },
    },
    exchange: {
      browse: {
      ...
      apply: {
        ...
        description: 'Nach links wischen, um sich zu bewerben.',
      },
      filters: {
        title: 'Filtereinstellungen',
        description: 'Tippen Sie auf das Zahnrad, um Entfernungs- und Reisezeitfilter anzupassen.',
      },
    },
    settings: {
      language: {
      ...
      homeLocation: {
        ...
        description: 'Standort festlegen für Filter nach Entfernung und Reisezeit.',
      },
      arrivalTime: {
        title: 'Ankunftszeit',
        description: 'Minuten vor Spielbeginn ankommen.',
      },
      complete: {
        title: 'Tour abgeschlossen!',
        description: 'Sie können die Touren jederzeit in den Einstellungen neu starten.',
      },
      tourSection: {
  ...
  common: {
    ...
    crossAssociationGameToday: 'Heute Spiel bei {association}',
    crossAssociationGameTomorrow: 'Morgen Spiel bei {association}',
    crossAssociationSwitchTo: 'Zu {association} wechseln',
    vs: 'vs',
    unknown: 'Unbekannt',
    unknownDate: 'Datum?',
    currencyChf: 'CHF',
  ...
  auth: {
    ...
    calendarValidationFailed:
      'Kalender konnte nicht validiert werden. Bitte versuchen Sie es erneut.',
  ...
  calendarError: {
    ...
    networkMessage:
      'Ihr Kalender konnte nicht geladen werden. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut.',
    invalidCodeMessage:
      'Der Kalendercode ist ungültig oder abgelaufen. Bitte melden Sie sich mit einem neuen Code an.',
    parseErrorMessage:
      'Einige Kalenderdaten konnten nicht gelesen werden. Verfügbare Einsätze werden angezeigt.',
    ok: 'OK',
  ...
  assignments: {
    ...
    gameReportNotAvailable: 'Spielberichte sind nur für NLA- und NLB-Spiele verfügbar.',
  ...
  exchange: {
    ...
    removeConfirm: 'Möchten Sie diesen Einsatz wirklich aus der Tauschbörse entfernen?',
    ...
    noApplicationsDescription: 'Sie haben noch keine Spiele zur Übernahme angeboten.',
  ...
  settings: {
    ...
    safeModeWarningPoint1: 'volleymanager.volleyball.ch ist die einzige massgebende Quelle',
    safeModeWarningPoint2:
      'Überprüfen Sie Ihre Änderungen immer auf der offiziellen VolleyManager-Website',
    safeModeWarningPoint3: 'VolleyKit übernimmt keine Verantwortung für allfällige Fehler',
  ...
  pwa: {
    ...
    newVersionDescription:
      'Klicken Sie auf Neu laden, um auf die neueste Version zu aktualisieren.',
    reload: 'Neu laden',
  ...
  pdf: {
    ...
    wizard: {
      ...
      nonConformant: {
        ...
        previewTitle: 'Rapport überprüfen',
        confirmAndSign: 'Bestätigen & Unterschreiben',
        signaturesTitle: 'Unterschriften',
        signaturesProgress: '{count} von {total}',
        firstRefereeLabel: '1. Schiedsrichter',
        secondRefereeLabel: '2. Schiedsrichter',
        ...
        stepComment: 'Kommentar',
        stepPreview: 'Vorschau',
        stepSign: 'Unterschriften',
      },

      sections: {
        fieldAndLines: 'Spielfeld und Feldlinien',
        warmUpArea: 'Aufwärmfläche',
        netEquipment: 'Netzanlage mit Antennen',
        refereeChair: 'Schiedsrichterstuhl',
        manometer: 'Manometer',
        measuringRod: 'Messlatte',
        lineFlags: 'Linienrichterfahnen',
        buzzer: 'Summer (Buzzer)',
        eScoresheet: 'eScoresheet',
        tablets: 'Tablets',
        scoreboard: 'Elektronische Anzeigetafel',
        balls: 'Bälle',
        ballRetrievers: 'Ballholer',
        quickMoppers: 'Quickmoppers',
        hallSpeaker: 'Hallensprecher',
        dressHome: 'Dress Heimmannschaft',
        dressAway: 'Dress Besuchermannschaft',
        miscellaneous: 'Verschiedenes',
        numberPlates: 'Nummerntafeln',
      },

      subItems: {
        boundaryLines: 'Begrenzungs-/Mittellinie (5 cm, Kontrast)',
        attackLine: 'Angriffslinie plus Verlängerung',
        freeZone: 'Freizone',
        warmUpArea: 'Aufwärmfläche (~300×300 cm)',
        antennas: '2 Antennen + Reserveantennen',
        netTopBand: 'Netzoberkante 7 cm weisses Band',
        netBottomBand: 'Netzunterkante 5 cm weisses Band',
        reserveNet: 'Reservenetz',
        postsNoWire: 'Pfosten ohne Spannseil',
        postsPadding: 'Pfosten mit Polsterung',
        tabletMount: 'Befestigungsmöglichkeiten für Tablets',
        netHeight: 'Netzhöhe korrekt',
        refereeChair: 'Schiedsrichterstuhl (höhenverstellbar)',
        manometer: 'Funktionierendes Manometer',
        measuringRod: 'Messlatte',
        lineFlags: '2 Fahnen für Linienrichter',
        buzzer: 'Summer funktionierend und gut hörbar',
        eScorerOnTime: 'eScorer rechtzeitig in der Halle',
        reserveLaptop: 'Reservelaptop (Spiel geladen)',
        usbStick: 'USB-Stick (mind. 1 GB)',
        reserveMatchSheet: 'Reserve-Matchblatt (Papier)',
        refereeTablets: 'Tablets mit Referee-Application',
        benchTablets: 'Tablets mit Bench-Application',
        matchKit: 'Matchtrikot',
        scoreboard: 'Elektronische Anzeigetafel vorhanden',
        scoreboardFunction: 'Anzeigetafel funktioniert',
        ballCount: 'Anzahl Bälle ausreichend',
        ballCondition: 'Zustand der Bälle',
        ballRetrievers: 'Ballholer vorhanden',
        ballRetrieversException: 'Ballholer (Ausnahmebewilligung)',
        quickMoppers: 'Quickmoppers vorhanden',
        hallSpeaker: 'Hallensprecher vorhanden',
        dressColor: 'Trikotfarbe konform',
        advertisingOnUniform: 'Werbung auf Spielerkleidung',
        liberoDress: 'Libero-Dress',
        miscItem1: 'Sonstiges 1',
        miscItem2: 'Sonstiges 2',
        numberPlatesHome: 'Nummerntafeln Heimmannschaft',
        numberPlatesAway: 'Nummerntafeln Besuchermannschaft',
        numberPlates: 'Nummerntafeln (2 Sätze, Nr. 1–20)',
        practiseBalls: 'Einspielbälle',
        matchBalls: 'Matchbälle',
        matchBallsException: 'Matchbälle (Ausnahmebewilligung)',
      },
    },
  },
  errorBoundary: {
  ...
  validation: {
    ...
    homeRosterPlaceholder: 'Die Überprüfung des Heimkaders wird hier verfügbar sein.',
    awayRosterPlaceholder: 'Die Überprüfung des Gastkaders wird hier verfügbar sein.',
    scorerPlaceholder: 'Die Schreiberidentifikation wird hier verfügbar sein.',
    scoresheetPlaceholder: 'Der Upload des Spielberichts wird hier verfügbar sein.',
    ...
    ocr: {
      ...
      scanScoresheetDescription:
        'Machen Sie ein Foto oder wählen Sie ein Bild des Spielberichts, um Spielernamen automatisch auszufüllen',
      takePhoto: 'Foto aufnehmen',
      ...
      errors: {
        cameraNotAvailable:
          'Kamera nicht verfügbar. Bitte verwenden Sie stattdessen die Dateiauswahl.',
        processingFailed:
          'Bild konnte nicht verarbeitet werden. Bitte versuchen Sie es mit einem klareren Foto.',
        noTextFound:
          'Kein Text im Bild erkannt. Bitte stellen Sie sicher, dass der Spielbericht gut sichtbar ist.',
      ...
      rawData: {
        ...
        role: 'Rolle',
        imageOverlay: 'Aufgenommenes Bild',
        hideOverlay: 'Rahmen ausblenden',
        showOverlay: 'Rahmen anzeigen',
        matchedWords: 'Übereinstimmend',
        otherWords: 'Andere',
  ...
  easterEggs: {
    ...
    multipleDoctors: {
      ...
      message:
        'Mehrere Ärzte auf der Bank? Entweder erwartet dieses Team ein hartes Spiel, oder es ist eine medizinische Fachkonferenz!',
    },
    dismiss: 'Verstanden!',
  },
}
