...
const it: Translations = {
  ...
  common: {
    ...
    crossAssociationGameToday: 'Partita oggi presso {association}',
    crossAssociationGameTomorrow: 'Partita domani presso {association}',
    crossAssociationSwitchTo: 'Passa a {association}',
    vs: 'vs',
    unknown: 'Sconosciuto',
    unknownDate: 'Data?',
    currencyChf: 'CHF',
  ...
  pdf: {
    ...
    wizard: {
      ...
      nonConformant: {
        ...
        selectSections: 'Selezionare le sezioni con problemi',
        selectSubItems: 'Selezionare i punti interessati',
        describeIssues: 'Descrivere i problemi',
        describeIssuesPerSection: 'Aggiungere un commento per ogni sezione segnalata',
        commentRequired: 'Commento obbligatorio',
        commentPlaceholder: 'Descrivere i problemi riscontrati...',
        issuesFoundIn: 'Problemi trovati in:',
        previewTitle: 'Verificare il rapporto',
        confirmAndSign: 'Conferma e firma',
        signaturesTitle: 'Firme',
        signaturesProgress: '{count} di {total}',
        firstRefereeLabel: '1° Arbitro',
        secondRefereeLabel: '2° Arbitro',
        ...
        next: 'Avanti',
        back: 'Indietro',
        stepSections: 'Sezioni',
        stepComment: 'Commento',
        stepPreview: 'Anteprima',
        stepSign: 'Firme',
      },

      sections: {
        fieldAndLines: 'Campo da gioco e linee',
        warmUpArea: 'Area di riscaldamento',
        netEquipment: 'Rete e antenne',
        refereeChair: 'Sedia arbitro',
        manometer: 'Manometro',
        measuringRod: 'Asta di misurazione',
        lineFlags: 'Bandierine giudici di linea',
        buzzer: 'Buzzer',
        eScoresheet: 'eScoresheet',
        tablets: 'Tablets',
        scoreboard: 'Tabellone elettronico',
        balls: 'Palloni',
        ballRetrievers: 'Raccattapalle',
        quickMoppers: 'Quick moppers',
        hallSpeaker: 'Speaker',
        dressHome: 'Divisa squadra di casa',
        dressAway: 'Divisa squadra ospite',
        miscellaneous: 'Varie',
        numberPlates: 'Targhe numerate',
      },

      subItems: {
        boundaryLines: 'Linee di delimitazione/mediana (5 cm, contrasto)',
        attackLine: "Linea d'attacco più prolungamento",
        freeZone: 'Zona libera',
        warmUpArea: 'Area di riscaldamento (~300×300 cm)',
        antennas: '2 antenne + antenne di riserva',
        netTopBand: 'Banda superiore rete 7 cm bianca',
        netBottomBand: 'Banda inferiore rete 5 cm bianca',
        reserveNet: 'Rete di riserva',
        postsNoWire: 'Pali senza cavo di tensione',
        postsPadding: 'Pali con imbottitura',
        tabletMount: 'Supporti per tablets',
        netHeight: 'Altezza rete corretta',
        refereeChair: 'Sedia arbitro (regolabile in altezza)',
        manometer: 'Manometro funzionante',
        measuringRod: 'Asta di misurazione',
        lineFlags: '2 bandierine per giudici di linea',
        buzzer: 'Buzzer funzionante e udibile',
        eScorerOnTime: 'eScorer puntuale nella sala',
        reserveLaptop: 'Laptop di riserva (partita caricata)',
        usbStick: 'Chiavetta USB (min. 1 GB)',
        reserveMatchSheet: 'Foglio partita di riserva (carta)',
        refereeTablets: 'Tablets con applicazione arbitro',
        benchTablets: 'Tablets con applicazione panchina',
        matchKit: 'Tenuta da partita',
        scoreboard: 'Tabellone elettronico presente',
        scoreboardFunction: 'Tabellone funzionante',
        ballCount: 'Numero di palloni sufficiente',
        ballCondition: 'Condizione dei palloni',
        ballRetrievers: 'Raccattapalle presenti',
        ballRetrieversException: 'Raccattapalle (sala con deroga)',
        quickMoppers: 'Quick moppers presenti',
        hallSpeaker: 'Speaker presente',
        dressColor: 'Colore divisa conforme',
        advertisingOnUniform: 'Pubblicità sulla divisa',
        liberoDress: 'Divisa del libero',
        miscItem1: 'Varie 1',
        miscItem2: 'Varie 2',
        numberPlatesHome: 'Targhe numerate squadra di casa',
        numberPlatesAway: 'Targhe numerate squadra ospite',
        numberPlates: 'Targhe numerate (2 set, n. 1–20)',
        practiseBalls: 'Palloni di riscaldamento',
        matchBalls: 'Palloni da partita',
        matchBallsException: 'Palloni da partita (sala con deroga)',
      },
    },
  },
  errorBoundary: {
