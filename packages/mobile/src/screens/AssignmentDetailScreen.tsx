 ...
 */
function getAssignmentDisplayData(
        ...
        <View className="gap-3">
          ...
          <View className="bg-gray-50 rounded-lg p-4">
            ...
            {display.latitude && display.longitude && (
              ...
              >
                ...
                <Text className="text-sky-500 ml-2 font-medium">
                  {t('common.openInMaps')}
                </Text>
              </TouchableOpacity>
            )}
          ...
          {display.hasExchange && (
            <View className="bg-amber-50 rounded-lg p-4 flex-row items-center">
              ...
              <Text className="text-amber-700 ml-3 flex-1">
                {t('assignments.exchangeOpen')}
              </Text>
            </View>
          )}
          ...
          {display.hasMessage && (
            <View className="bg-sky-50 rounded-lg p-4 flex-row items-center">
              ...
              <Text className="text-sky-700 ml-3 flex-1">
                {t('assignments.hasMessage')}
              </Text>
            </View>
          )}
            ...
            <View className="bg-purple-50 rounded-lg p-4 flex-row items-center">
              ...
              <View className="ml-3 flex-1">
                <Text className="text-purple-700">
                  {t('assignments.doubleConvocation')}
                </Text>
