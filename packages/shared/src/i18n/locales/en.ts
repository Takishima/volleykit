...
const en: Translations = {
  ...
  assignments: {
    ...
    exchangeOpen: 'This assignment is listed for exchange',
    hasMessage: 'There is a message from the referee coordinator',
  ...
  settings: {
    ...
    calendar: {
      ...
      noCalendarCode: 'Calendar code not available. Please log in again.',
      enabled: 'Enabled',
      disabled: 'Disabled',
    },
    departure: {
