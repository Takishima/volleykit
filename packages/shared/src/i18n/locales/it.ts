...
const it: Translations = {
  ...
  assignments: {
    ...
    notFound: 'Designazione non trovata',
    gameNumber: 'Numero partita',
    confirmationStatus: 'Conferma',
    exchangeOpen: 'Questa designazione è in borsa scambi',
    hasMessage: "C'è un messaggio dal coordinatore arbitri",
    doubleConvocation: 'Doppia convocazione',
  },
  compensations: {
    title: 'Compensi',
