...
export function sortByGameDate<
  T extends { refereeGame?: { game?: { startingDateTime?: string | null } } },
>(items: T[], descending = false): T[] {
 ...
 */
export function getGameTimestamp(assignment: {
  refereeGame?: { game?: { startingDateTime?: string | null } }
}): number {
...
export function useAssignments(
  ...
  const { apiClient, period = 'upcoming', customRange, associationKey, enabled = true } = options
