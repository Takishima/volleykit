...
describe('useModalState', () => {
  ...
  describe('custom cleanup delay', () => {
    it('should use custom cleanup delay when provided', () => {
      ...
      const { result } = renderHook(() => useModalState<TestData>({ cleanupDelay: customDelay }))
    ...
    it('should allow zero cleanup delay', () => {
      const { result } = renderHook(() => useModalState<TestData>({ cleanupDelay: 0 }))
  ...
  describe('type safety', () => {
    it('should work with different data types', () => {
      ...
      const { result: complexResult } = renderHook(() => useModalState<ComplexData>())
      act(() => {
  ...
  describe('function stability', () => {
    ...
    it('should maintain stable close reference when cleanupDelay is stable', () => {
      const { result, rerender } = renderHook(() => useModalState<TestData>({ cleanupDelay: 300 }))
