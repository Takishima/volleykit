...
describe('ErrorFallbackUI', () => {
  ...
  describe('network error state', () => {
    it('renders network error title', () => {
      render(<ErrorFallbackUI error={null} errorType="network" onReset={mockOnReset} />)
    ...
    it('renders network icon with aria-hidden', () => {
      const { container } = render(
        <ErrorFallbackUI error={null} errorType="network" onReset={mockOnReset} />
      )
  ...
  describe('application error state', () => {
    it('renders application error title', () => {
      render(<ErrorFallbackUI error={null} errorType="application" onReset={mockOnReset} />)
    ...
    it('renders warning icon with aria-hidden', () => {
      const { container } = render(
        <ErrorFallbackUI error={null} errorType="application" onReset={mockOnReset} />
      )
  ...
  describe('error details', () => {
    ...
    it('renders error details when error is provided', () => {
      ...
      render(<ErrorFallbackUI error={testError} errorType="application" onReset={mockOnReset} />)
