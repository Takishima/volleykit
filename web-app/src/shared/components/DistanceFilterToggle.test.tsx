...
describe('DistanceFilterToggle', () => {
  it('renders with unchecked state', () => {
    ...
    render(<DistanceFilterToggle checked={false} onChange={onChange} maxDistanceKm={50} />)
  ...
  it('renders with checked state', () => {
    ...
    render(<DistanceFilterToggle checked={true} onChange={onChange} maxDistanceKm={50} />)
  ...
  it('displays different distance values', () => {
    ...
    const { rerender } = render(
      <DistanceFilterToggle checked={true} onChange={onChange} maxDistanceKm={25} />
    )

    expect(screen.getByText('≤25 km')).toBeInTheDocument()

    rerender(<DistanceFilterToggle checked={true} onChange={onChange} maxDistanceKm={100} />)
  ...
  it('shows icon when checked', () => {
    ...
    const { container } = render(
      <DistanceFilterToggle checked={true} onChange={onChange} maxDistanceKm={50} />
    )
