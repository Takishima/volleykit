...
function getLeaguesForAssociation(associationCode: DemoAssociationCode): LeagueConfig[] {
...
function getRequiredOfficials(leagueName: string, gender: 'm' | 'f'): RequiredOfficials {
...
function getVenuesForAssociation(associationCode: DemoAssociationCode): VenueConfig[] {
