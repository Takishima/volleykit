...
export interface DemoState
  ...
  initializeDemoData: (associationCode?: import('../demo-generators').DemoAssociationCode) => void
  clearDemoData: () => void
  refreshData: () => void
  setActiveAssociation: (associationCode: import('../demo-generators').DemoAssociationCode) => void
