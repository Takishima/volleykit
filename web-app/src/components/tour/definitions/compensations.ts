...
export const compensationsTour: TourDefinition = {
  ...
  steps: [
    ...
    },
    {
      id: "tap-edit",
      targetSelector: "[data-tour='compensation-card']",
      titleKey: "tour.compensations.tapEdit.title",
      descriptionKey: "tour.compensations.tapEdit.description",
      placement: "bottom",
    ...
    },
    {
      ...
      titleKey: "tour.compensations.downloadPdf.title",
      descriptionKey: "tour.compensations.downloadPdf.description",
      placement: "top",
      completionEvent: { type: "click" },
    },
  ],
