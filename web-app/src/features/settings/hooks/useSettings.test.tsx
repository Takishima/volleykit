...
describe('useAssociationSettings', () => {
  ...
  it('handles API errors gracefully', async () => {
    ...
    const api = await getApi()
    vi.mocked(api.getAssociationSettings).mockRejectedValue(new Error('Network error'))
...
describe('useActiveSeason', () => {
  ...
  it('handles API errors gracefully', async () => {
    ...
    const api = await getApi()
    vi.mocked(api.getActiveSeason).mockRejectedValue(new Error('API unavailable'))
