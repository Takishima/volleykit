...
async function getActiveAssociation() {
  const { useActiveAssociationCode } = await import('@/features/auth/hooks/useActiveAssociation')
...
describe('useTransportSettings', () => {
  ...
  async function setupMocks(
    ...
    vi.mocked(useTravelTimeAvailable).mockReturnValue(options.isTransportAvailable ?? true)
  ...
  it('toggles transport for current association', async () => {
    ...
    expect(mockSetTransportEnabledForAssociation).toHaveBeenCalledWith('FVRZ', true)
  })
