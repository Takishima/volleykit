...
const mockGameDetails = {
  ...
  nominationListOfTeamHome: {
    ...
    indoorPlayerNominations: [{ __identity: 'player-1' }, { __identity: 'player-2' }],
...
describe('useValidationState', () => {
  ...
  describe('roster modifications', () => {
    it('updates home roster modifications and marks as reviewed', () => {
      ...
      expect(result.current.state.homeRoster.playerModifications.added).toHaveLength(1)
    ...
    it('updates away roster modifications and marks as reviewed', () => {
      ...
      expect(result.current.state.awayRoster.playerModifications.removed).toHaveLength(1)
  ...
  describe('reset', () => {
    it('resets all state to initial values', () => {
      ...
      act(() => {
        ...
        result.current.setScorer(mockScorer)
        result.current.setScoresheet(new File([''], 'test.pdf'), true)
      })
