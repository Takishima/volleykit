...
import { degreesToRadians, getRotatedBoundingBox, calculateGuideCropArea } from './image-crop'
import {
  ...
  describe('calculateGuideCropArea', () => {
    ...
    describe('manuscript scoresheet (90% width, 4:5 aspect)', () => {
      ...
      it('uses larger crop area than electronic for same input', () => {
        const electronic = calculateGuideCropArea(1920, 1080, 800, 600, 'electronic')
        const manuscript = calculateGuideCropArea(1920, 1080, 800, 600, 'manuscript')
    ...
    describe('edge cases', () => {
      it('handles square video and container', () => {
        const size = 1000
        const result = calculateGuideCropArea(size, size, 500, 500, 'electronic')
      ...
      it('maintains 4:5 aspect ratio in output', () => {
        const result = calculateGuideCropArea(1920, 1080, 800, 600, 'electronic')
