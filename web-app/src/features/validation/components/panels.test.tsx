...
describe('ScoresheetPanel', () => {
  ...
  function getCameraInput(): HTMLInputElement {
    const input = document.querySelector<HTMLInputElement>('input[capture="environment"]')
    if (!input) {
  ...
  describe('Accessibility', () => {
    ...
    it('displays error with role alert', () => {
      ...
      expect(alert).toHaveTextContent('Invalid file type. Please use JPEG, PNG, or PDF.')
    })
  ...
  describe('Edge Cases', () => {
    ...
    it('displays file name with truncation class for long names', () => {
      render(<ScoresheetPanel />, { wrapper: createWrapper() })
      const longFileName = 'this_is_a_very_long_file_name_that_should_be_truncated_in_the_ui.jpg'
    ...
    it('displays correct file size formatting for KB', () => {
      ...
      uploadTestFile(getFileInput(), 'small.jpg', 'image/jpeg', kbContent)
    ...
    it('displays correct file size formatting for MB', () => {
      ...
      uploadTestFile(getFileInput(), 'large.jpg', 'image/jpeg', mbContent)
