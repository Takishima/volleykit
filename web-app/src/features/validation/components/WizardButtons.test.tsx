...
describe('EditModeButtons', () => {
  ...
  it('shows Cancel button on first step', () => {
    render(
      <EditModeButtons {...defaultProps} navigation={{ isFirstStep: true, isLastStep: false }} />
    )
  ...
  it('calls onValidateAndNext when Validate button is clicked', async () => {
    ...
    render(<EditModeButtons {...defaultProps} onValidateAndNext={onValidateAndNext} />)
  ...
  it('disables buttons when isLoadingGameDetails is true', () => {
    render(
      <EditModeButtons {...defaultProps} state={{ ...defaultState, isLoadingGameDetails: true }} />
    )
  ...
  it('disables buttons when hasGameDetailsError is true', () => {
    render(
      <EditModeButtons {...defaultProps} state={{ ...defaultState, hasGameDetailsError: true }} />
    )
