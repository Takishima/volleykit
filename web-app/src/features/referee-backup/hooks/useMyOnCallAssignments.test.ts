...
import { isUserAssignment, extractUserOnCallAssignments } from './useMyOnCallAssignments'
    ...
    const entries: RefereeBackupEntry[] = [
      {
        ...
        weekday: 'Mi',
        calendarWeek: 3,
        nlaReferees: [createAssignment('nla-1', 'other-user'), createAssignment('nla-2', userId)],
      },
    ]
