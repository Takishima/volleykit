...
const de: Translations = {
  ...
  sync: {
    ...
    resultsTitle: 'Synchronisierungsergebnis',
    successCount: '{{count}} Änderung synchronisiert',
    successCount_other: '{{count}} Änderungen synchronisiert',
    conflictCount: '{{count}} Aktion konnte nicht abgeschlossen werden',
    conflictCount_other: '{{count}} Aktionen konnten nicht abgeschlossen werden',
    conflict: {
      already_taken: 'Dieses Spiel wurde bereits von einem anderen Schiedsrichter übernommen.',
      not_found: 'Dieses Element existiert nicht mehr.',
      expired: 'Das Zeitfenster für diese Aktion ist abgelaufen.',
