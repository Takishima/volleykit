...
const fr: Translations = {
  ...
  sync: {
    ...
    resultsTitle: 'Résultats de synchronisation',
    successCount: '{{count}} modification synchronisée',
    successCount_other: '{{count}} modifications synchronisées',
    conflictCount: "{{count}} action n'a pas pu être complétée",
    conflictCount_other: "{{count}} actions n'ont pas pu être complétées",
    conflict: {
      already_taken: 'Ce match a été pris par un autre arbitre pendant que vous étiez hors ligne.',
      not_found: "Cet élément n'existe plus.",
      expired: 'Le délai pour cette action est expiré.',
