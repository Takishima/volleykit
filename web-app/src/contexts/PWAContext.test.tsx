...
function TestConsumer() {
  ...
  return (
    <div>
      ...
      <span data-testid="registrationError">{registrationError?.message ?? 'null'}</span>
...
describe('PWAContext', () => {
  ...
  describe('PWAProvider', () => {
    ...
    it('sets registrationError when onRegisterError is called', async () => {
      ...
      expect(screen.getByTestId('registrationError')).toHaveTextContent('Registration failed')
    })
    ...
    it('sets registrationError when registerSW throws', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('registrationError')).toHaveTextContent('Import failed')
      })
    ...
    it('clears interval on unmount', async () => {
      ...
      act(() => {
        onRegisteredSWCallback?.('sw.js', mockRegistration as unknown as ServiceWorkerRegistration)
      })
