...
export const fr: TranslationKeys = {
  ...
  home: {
    ...
    features: {
      gettingStarted: {
        title: 'Premiers pas',
        description: 'Guide de démarrage rapide pour configurer et utiliser VolleyKit.',
      },
      assignments: {
        title: 'Désignations',
        description: "Consultez et gérez vos prochains matchs d'arbitrage de volleyball.",
      },
      exchanges: {
        title: 'Échanges',
        description: "Demandez des échanges et proposez vos désignations à d'autres arbitres.",
      },
      compensations: {
        title: 'Indemnités',
        description: "Suivez vos gains d'arbitrage et l'historique de vos indemnités.",
      },
      calendarMode: {
        title: 'Mode calendrier',
        description: 'Accès en lecture seule aux désignations sans connexion.',
      },
      travelTime: {
        title: 'Temps de trajet',
        description: 'Calculez les temps de trajet avec les transports publics suisses.',
      },
      offlinePwa: {
        title: 'Hors ligne & PWA',
        description: "Installez l'app et utilisez-la hors ligne sur votre appareil.",
      },
      settings: {
        title: 'Paramètres',
  ...
  pages: {
    ...
    compensations: {
      title: 'Indemnités',
      description: "Apprenez à suivre et comprendre vos paiements d'indemnités d'arbitrage.",
    },
    calendarMode: {
      title: 'Mode calendrier',
      description:
  ...
  search: {
    ...
    unavailableHint: 'Exécutez une build de production pour activer la recherche',
  ...
  gettingStarted: {
    ...
    whatIs: {
      ...
      description:
        'VolleyKit se connecte à la plateforme officielle volleymanager.volleyball.ch et offre aux arbitres une interface moderne et adaptée aux mobiles pour :',
      features: {
      ...
      infoBox:
        "VolleyKit est une application non officielle créée pour améliorer l'expérience des arbitres. Toutes les données proviennent du système volleymanager officiel.",
    },
    howToLogin: {
      ...
      calendarMode: {
        ...
        description:
          'Pour un accès rapide à votre planning sans entrer votre mot de passe, vous pouvez utiliser le mode calendrier avec votre URL ou code de calendrier unique de volleymanager.',
        steps: {
          findUrl: {
            title: 'Trouver votre URL de calendrier',
            description:
              'Dans volleymanager, allez dans "Mes désignations" et copiez votre URL d\'abonnement au calendrier.',
          },
          selectMode: {
            title: 'Sélectionner le mode calendrier',
            description:
              'Sur la page de connexion VolleyKit, appuyez sur l\'onglet "Mode calendrier".',
          },
          pasteUrl: {
            title: 'Coller votre URL ou code',
            description:
              'Entrez votre URL de calendrier ou juste le code pour accéder à votre planning.',
          },
        },
        infoBox:
          'Le mode calendrier offre un accès en lecture seule – vous pouvez voir les désignations mais ne pouvez pas confirmer les matchs, demander des échanges ou accéder aux indemnités. Voir le guide du mode calendrier pour plus de détails.',
      },
      fullLogin: {
        title: 'Option 2 : Connexion complète',
        description:
          'Utilisez vos identifiants volleymanager.volleyball.ch pour un accès complet à toutes les fonctionnalités.',
        steps: {
          openApp: {
            title: 'Ouvrir VolleyKit',
            description:
              "Naviguez vers l'application VolleyKit dans votre navigateur ou ouvrez l'application installée.",
          },
          enterCredentials: {
            title: 'Entrer vos identifiants',
            description:
              "Utilisez votre nom d'utilisateur et mot de passe volleymanager pour vous connecter.",
          },
          stayLoggedIn: {
        ...
        screenshotAlt:
          "Page de connexion VolleyKit montrant les champs nom d'utilisateur et mot de passe",
        screenshotCaption: 'La page de connexion VolleyKit',
        tipTitle: 'Mot de passe oublié ?',
        tipContent:
          'VolleyKit utilise les mêmes identifiants que volleymanager.volleyball.ch. Utilisez la fonction de réinitialisation du mot de passe sur le site officiel si vous avez oublié votre mot de passe.',
      },
    },
    quickTour: {
      title: 'Visite rapide',
      description:
        'Après la connexion, vous verrez le tableau de bord principal avec vos prochaines désignations. Voici un aperçu rapide des sections principales :',
      assignments: {
        title: 'Désignations',
        description:
          "Voir tous vos prochains matchs d'arbitrage. Chaque désignation affiche la date, l'heure, les équipes, le lieu et votre rôle (1er arbitre, 2e arbitre ou juge de ligne).",
      },
      exchanges: {
        title: 'Échanges',
        description:
          "Parcourir les échanges disponibles d'autres arbitres ou demander un échange pour l'une de vos désignations.",
      },
      compensations: {
        title: 'Indemnités',
        description:
          "Suivre vos paiements d'arbitrage et l'historique des indemnités. Filtrer par période et exporter vos données.",
      },
      settings: {
        title: 'Paramètres',
        description:
          'Personnaliser votre expérience incluant la langue, le lieu de domicile pour les calculs de trajet et les préférences de notification.',
      },
    },
    nextSteps: {
      title: 'Prochaines étapes',
      description:
        'Maintenant que vous êtes familier avec les bases, explorez les guides détaillés pour chaque fonctionnalité :',
      links: {
  ...
  assignments: {
    ...
    whatAre: {
      ...
      description:
        'Les désignations sont les matchs pour lesquels vous avez été programmé comme arbitre. Chaque désignation comprend :',
      details: {
    ...
    viewing: {
      ...
      description:
        "La liste des désignations affiche tous vos prochains matchs dans l'ordre chronologique. Les matchs sont groupés par date pour voir facilement ce qui arrive.",
    ...
    details: {
      ...
      description:
        'Appuyez sur une désignation pour voir tous les détails. La vue détaillée comprend :',
      items: {
    ...
    actions: {
      ...
      description:
        'VolleyKit utilise des gestes de balayage pour accéder rapidement aux actions sur vos cartes de désignation. Selon le statut du match, différentes actions peuvent être disponibles.',
      swipeRight: {
        title: "Balayer à droite – Ajouter à l'échange",
        description:
          "Balayez une carte de désignation vers la droite pour révéler l'action d'échange. Si vous ne pouvez pas assister à un match, vous pouvez l'ajouter au tableau d'échange pour d'autres arbitres.",
        ...
        warning:
          "Assurez-vous de demander un échange bien à l'avance. Les demandes de dernière minute peuvent ne pas trouver de remplaçant à temps.",
      },
      swipeLeft: {
        title: 'Balayer à gauche – Valider & Modifier',
        description:
          'Balayez une carte de désignation vers la gauche pour révéler des actions supplémentaires :',
        validate:
      ...
      directions: {
        ...
        description:
          "Appuyez sur une carte de désignation pour l'agrandir, puis utilisez le bouton d'itinéraire pour ouvrir votre application de cartes préférée avec les directions vers le lieu.",
      },
    },
    upcomingPast: {
  ...
  exchanges: {
    ...
    whatAre: {
      ...
      description:
        "Un échange est une demande d'un arbitre qui ne peut pas assister à son match programmé et cherche un remplaçant. Le système volleymanager maintient un tableau d'échange où les arbitres peuvent :",
      features: {
      ...
      infoBox:
        "Les échanges sont gérés via le système volleymanager officiel. VolleyKit offre une interface plus conviviale au même tableau d'échange.",
    },
    requesting: {
      title: 'Demander un échange',
      description:
        "Quand vous ne pouvez pas assister à l'un de vos matchs programmés, vous pouvez demander un échange pour trouver un arbitre remplaçant.",
      steps: {
        findAssignment: {
          title: 'Trouver la désignation',
          description:
            "Allez dans l'onglet Désignations et localisez le match que vous voulez échanger.",
        },
        swipeRight: {
          title: 'Balayer à droite sur la carte',
          description:
            "Balayez la carte de désignation vers la droite pour révéler l'action d'échange, puis appuyez dessus. Le match sera publié sur le tableau d'échange.",
        },
      },
      ...
      warningContent:
        'Plus vous demandez un échange tôt, plus vous avez de chances de trouver un remplaçant. Les demandes de dernière minute restent souvent sans réponse.',
    },
    viewing: {
      title: 'Voir les échanges disponibles',
      description:
        "L'onglet Échanges affiche tous les matchs actuellement disponibles pour échange. Ce sont des matchs que d'autres arbitres ont publiés et pour lesquels ils cherchent des remplaçants.",
      ...
      filtering: {
        ...
        description:
          "Filtrez la liste d'échanges pour trouver des matchs qui vous conviennent. Les filtres deviennent disponibles après avoir configuré les paramètres requis :",
        distance:
          'Distance – Filtrer par distance maximale depuis votre domicile. Nécessite de définir votre domicile dans les Paramètres.',
        travelTime:
          "Temps de trajet – Filtrer par temps de trajet maximum en transports publics. Nécessite à la fois un domicile et l'activation de l'API des transports publics dans les Paramètres.",
        usage:
          "Une fois les filtres disponibles, ils apparaissent comme des puces à bascule à côté de l'icône d'engrenage. Appuyez sur l'engrenage pour configurer les valeurs maximales pour chaque filtre.",
    ...
    accepting: {
      ...
      description:
        "Quand vous trouvez un match que vous aimeriez prendre, vous pouvez accepter l'échange :",
      steps: {
        review: {
        ...
        swipeLeft: {
          ...
          description:
            "Balayez la carte d'échange vers la gauche pour révéler l'action de reprise, puis appuyez dessus.",
        },
        confirm: {
    ...
    managing: {
      ...
      description:
        "Vous pouvez voir et gérer vos demandes d'échange actives depuis l'onglet Échanges. Si vous n'avez plus besoin d'un échange (ex: votre planning a changé), vous pouvez annuler la demande avant que quelqu'un l'accepte.",
      canceling: {
        ...
        steps: {
          ...
          selectAddedByMe:
            'Sélectionnez l\'onglet "Ajoutés par moi" pour voir vos demandes en attente',
          swipeRight:
            "Balayez à droite sur la carte de demande pour révéler l'action de suppression, puis appuyez dessus",
          confirmCancellation: "Confirmez l'annulation",
        },
        infoBox:
          "Vous ne pouvez annuler une demande d'échange que si personne ne l'a encore acceptée. Une fois accepté, l'échange est définitif.",
      },
    },
  },
  ...
  compensations: {
    ...
    whatAre: {
      ...
      description:
        "Les indemnités sont les paiements que vous recevez pour arbitrer des matchs de volleyball. Chaque entrée d'indemnité comprend généralement :",
      details: {
      ...
      infoBox:
        "Les montants d'indemnité sont fixés par Swiss Volley et varient selon le niveau de ligue et votre rôle dans le match.",
    },
    viewing: {
      title: 'Voir vos indemnités',
      description:
        "La liste des indemnités affiche tous vos paiements enregistrés dans l'ordre chronologique. Chaque entrée affiche les informations clés d'un coup d'œil.",
      screenshotAlt:
        "Liste d'indemnités montrant l'historique des paiements avec montants et dates",
    ...
    exportPdf: {
      ...
      description:
        "Vous pouvez exporter des enregistrements d'indemnités individuels en documents PDF. Balayez à gauche sur une carte d'indemnité pour révéler l'action d'export PDF.",
      usage:
    ...
    paymentSchedule: {
      ...
      description:
        "Les paiements d'indemnités sont généralement traités mensuellement par Swiss Volley. Le calendrier exact peut varier, mais généralement :",
      details: {
        processing: 'Les matchs du mois précédent sont traités au début de chaque mois',
        bankTransfer:
          'Les paiements sont effectués par virement bancaire sur votre compte enregistré',
        timing: 'Le traitement peut prendre 2-4 semaines après la fin du mois',
      },
      warning:
        'Assurez-vous que vos coordonnées bancaires sont à jour dans le système volleymanager pour éviter les retards de paiement.',
    },
  },
  ...
  calendarMode: {
    ...
    whatIs: {
      ...
      description:
        "Le mode calendrier est une méthode d'accès légère en lecture seule qui vous permet de voir vos prochaines désignations sans entrer votre mot de passe. Il utilise un code de calendrier unique lié à votre compte d'arbitre.",
      features: {
    ...
    whoIsFor: {
      ...
      useCases: {
        ...
        familyMembers:
          'Membres de la famille – Partager votre planning avec partenaires ou famille',
        calendarIntegration:
          'Intégration calendrier – Ajouter des matchs à des applications de calendrier externes',
    ...
    howToAccess: {
      ...
      description:
        'Pour utiliser le mode calendrier, vous avez besoin de votre code de calendrier unique du système volleymanager.',
      steps: {
        findCode: {
          title: 'Trouver votre code de calendrier',
          description:
            'Connectez-vous à volleymanager.volleyball.ch et trouvez votre code de calendrier dans les paramètres de votre profil.',
        },
        openApp: {
          title: 'Ouvrir VolleyKit',
        ...
        enterCode: {
          ...
          description:
            'Entrez votre code de calendrier pour accéder à votre planning en lecture seule.',
        },
      },
    ...
    viewingSchedule: {
      ...
      description:
        "En mode calendrier, vous verrez vos prochaines désignations dans une vue simplifiée. L'interface affiche les informations essentielles pour chaque match.",
    ...
    limitations: {
      ...
      description:
        'Le mode calendrier est en lecture seule, ce qui signifie que certaines fonctionnalités ne sont pas disponibles :',
      table: {
      ...
      infoBox:
        'Pour des actions comme confirmer des désignations ou demander des échanges, vous devrez vous connecter avec vos identifiants complets.',
    },
    security: {
      title: 'Garder votre code sécurisé',
      description:
        'Bien que le mode calendrier soit en lecture seule, votre code de calendrier doit quand même être traité avec soin :',
      tips: {
      ...
      warning:
        "Votre code de calendrier révèle votre planning de matchs complet. Ne le partagez qu'avec des personnes à qui vous faites confiance pour connaître vos déplacements.",
    },
  },
  ...
  travelTime: {
    ...
    howItWorks: {
      ...
      description:
        "La fonctionnalité temps de trajet utilise l'API des transports publics suisses (CFF/öV) pour calculer les temps de trajet depuis votre domicile vers chaque lieu de match. Elle prend en compte :",
      considerations: {
      ...
      infoBox:
        'Les temps de trajet sont calculés avec les transports publics. Si vous conduisez habituellement, utilisez les temps comme estimation approximative ou pour planifier des options de transport alternatives.',
    },
    settingHome: {
      title: 'Définir votre domicile',
      description:
        "Pour obtenir des temps de trajet précis, vous devez définir votre domicile dans les paramètres de l'application.",
      steps: {
        openSettings: {
        ...
        enterAddress: {
          ...
          description:
            'Tapez votre adresse ou la gare depuis laquelle vous voyagez habituellement.',
        },
        saveSettings: {
    ...
    viewingTimes: {
      ...
      description:
        'Une fois votre domicile défini, les temps de trajet apparaissent sur vos cartes de désignation et dans la vue détaillée de désignation.',
    ...
    journeyDetails: {
      ...
      sbbLink:
        "Vous pouvez aussi ouvrir le trajet directement dans l'application ou le site CFF pour des mises à jour en temps réel et l'achat de billets.",
    ...
    arrivalBuffer: {
      ...
      description:
        "L'heure de départ suggérée inclut une marge pour s'assurer que vous arrivez avant le début du match :",
      details: {
      ...
      warning:
        'Prévoyez toujours du temps supplémentaire pour les matchs importants ou les lieux inconnus. Les transports publics peuvent subir des retards inattendus.',
    },
    offlineAvailability: {
      title: 'Disponibilité hors ligne',
      description:
        'Les temps de trajet sont mis en cache quand vous les consultez en ligne. Si vous êtes hors ligne :',
      details: {
  ...
  offlinePwa: {
    ...
    whatIsPwa: {
      ...
      description:
        'Une Progressive Web App est un site web qui fonctionne comme une application native. Quand vous installez VolleyKit :',
      benefits: {
    ...
    installing: {
      ...
      description:
        "Vous pouvez installer VolleyKit sur n'importe quel appareil moderne – téléphones, tablettes ou ordinateurs.",
      ios: {
        ...
        steps: {
          ...
          confirmInstall: {
            ...
            description:
              'Appuyez sur "Ajouter" pour installer VolleyKit sur votre écran d\'accueil.',
          },
        },
      },
      android: {
        ...
        steps: {
          ...
          lookForPrompt: {
            ...
            description:
              "Une bannière ou invite devrait apparaître demandant d'installer l'application.",
          },
          tapInstall: {
      ...
      desktop: {
        ...
        description:
          "Cherchez l'icône d'installation dans la barre d'adresse (généralement un + ou icône d'ordinateur), ou utilisez le menu du navigateur pour trouver \"Installer VolleyKit\".",
      },
    },
    whatWorksOffline: {
      title: 'Ce qui fonctionne hors ligne',
      description:
        'Quand vous êtes hors ligne, vous pouvez toujours accéder au contenu que vous avez consulté précédemment :',
      table: {
        feature: 'Fonctionnalité',
        offline: 'Hors ligne',
        notes: 'Notes',
      ...
      infoBox:
        "L'application se synchronise automatiquement quand vous êtes de retour en ligne. Tous les changements de données seront récupérés et affichés.",
    },
    offlineIndicator: {
      title: 'Indicateur hors ligne',
      description:
        "Quand vous êtes hors ligne, VolleyKit affiche un indicateur visuel pour que vous sachiez que vous consultez des données en cache. Cherchez le badge hors ligne dans l'en-tête ou une bannière en haut de l'écran.",
    ...
    updating: {
      ...
      description:
        'VolleyKit se met à jour automatiquement en arrière-plan. Quand une nouvelle version est disponible :',
      steps: {
    ...
    storage: {
      ...
      description:
        "VolleyKit utilise un stockage minimal sur votre appareil – généralement moins de 5Mo pour l'application elle-même plus les données en cache. Vous pouvez vider le cache depuis les paramètres de votre navigateur si nécessaire.",
      warning:
        'Vider les données du navigateur ou "Vider le cache" supprimera vos données hors ligne. Vous devrez peut-être recharger les désignations la prochaine fois que vous ouvrirez l\'application.',
    },
  },
  ...
  settings: {
    ...
    accessing: {
      ...
      description:
        'Ouvrez les paramètres en appuyant sur l\'icône d\'engrenage dans la barre de navigation, ou en sélectionnant "Paramètres" dans le menu principal.',
    ...
    profile: {
      ...
      infoBox:
        'Les informations de profil proviennent de volleymanager et ne peuvent être modifiées que sur le site officiel, pas dans VolleyKit.',
      loggingOut: {
        title: 'Déconnexion',
        description:
          'Appuyez sur "Déconnexion" pour vous déconnecter de votre compte. Cela efface votre session et toutes les données stockées localement.',
      },
    },
    language: {
      ...
      autoDetect:
        "L'application utilisera automatiquement la langue de votre navigateur si elle est supportée, mais vous pouvez la modifier dans les paramètres.",
    ...
    homeLocation: {
      title: 'Domicile',
      description:
        'Définissez votre domicile pour activer les calculs de temps de trajet. Ceci est utilisé pour montrer combien de temps il faut pour atteindre chaque lieu de match.',
      instructions: {
    ...
    dataPrivacy: {
      ...
      localStorage: {
        ...
        description:
          "VolleyKit stocke des données localement pour permettre l'accès hors ligne et améliorer les performances :",
        items: {
      ...
      clearData: {
        ...
        description:
          'Vous pouvez effacer toutes les données stockées localement depuis la page paramètres. Cela va :',
        effects: {
        ...
        warning:
          "L'effacement des données locales ne peut pas être annulé. Vous devrez recharger vos désignations la prochaine fois que vous ouvrirez l'application.",
      },
    ...
    about: {
      ...
      items: {
        ...
        lastUpdated:
          "Dernière mise à jour – Quand l'application a été mise à jour pour la dernière fois",
