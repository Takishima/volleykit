...
export const de: TranslationKeys = {
  ...
  home: {
    ...
    features: {
      gettingStarted: {
        ...
        description: 'Schnellstartanleitung zur Einrichtung und Nutzung von VolleyKit.',
      },
      assignments: {
        title: 'Einsätze',
        description: 'Sehen und verwalten Sie Ihre anstehenden Volleyball-Schiedsrichterspiele.',
      },
      exchanges: {
        title: 'Tauschbörse',
        description:
      ...
      compensations: {
        title: 'Vergütungen',
        description: 'Verfolgen Sie Ihre Schiedsrichtervergütungen und deren Verlauf.',
      },
      calendarMode: {
        title: 'Kalendermodus',
        description: 'Nur-Lese-Zugriff auf Einsätze ohne Anmeldung.',
      },
      travelTime: {
        title: 'Reisezeit',
        description: 'Reisezeiten mit Schweizer ÖV-Integration berechnen.',
      },
      offlinePwa: {
        title: 'Offline & PWA',
        description: 'App installieren und offline auf Ihrem Gerät nutzen.',
      },
      settings: {
        title: 'Einstellungen',
  ...
  search: {
    ...
    unavailableHint: 'Führen Sie einen Produktions-Build aus, um die Suche zu aktivieren',
  ...
  gettingStarted: {
    ...
    whatIs: {
      ...
      description:
        'VolleyKit verbindet sich mit der offiziellen volleymanager.volleyball.ch-Plattform und bietet Schiedsrichtern eine moderne, mobilfreundliche Oberfläche für:',
      features: {
      ...
      infoBox:
        'VolleyKit ist eine inoffizielle App, die zur Verbesserung der Schiedsrichtererfahrung erstellt wurde. Alle Daten stammen aus dem offiziellen volleymanager-System.',
    },
    howToLogin: {
      ...
      calendarMode: {
        ...
        description:
          'Für einen schnellen Zugriff auf Ihren Spielplan ohne Passwort können Sie den Kalendermodus mit Ihrer eindeutigen Kalender-URL oder Ihrem Code aus volleymanager nutzen.',
        steps: {
          findUrl: {
            title: 'Kalender-URL finden',
            description:
              'Gehen Sie in volleymanager zu "Meine Einsätze" und kopieren Sie Ihre Kalender-Abonnement-URL.',
          },
          selectMode: {
          ...
          pasteUrl: {
            ...
            description:
              'Geben Sie Ihre Kalender-URL oder nur den Code-Teil ein, um auf Ihren Spielplan zuzugreifen.',
          },
        },
        infoBox:
          'Der Kalendermodus bietet nur Lesezugriff – Sie können Einsätze anzeigen, aber keine Spiele bestätigen, Tausche anfordern oder auf Vergütungen zugreifen. Weitere Details finden Sie im Kalendermodus-Leitfaden.',
      },
      fullLogin: {
        title: 'Option 2: Vollständige Anmeldung',
        description:
          'Verwenden Sie Ihre volleymanager.volleyball.ch-Anmeldedaten für vollen Zugriff auf alle Funktionen.',
        steps: {
          openApp: {
            title: 'VolleyKit öffnen',
            description:
              'Navigieren Sie zur VolleyKit-App in Ihrem Browser oder öffnen Sie die installierte App.',
          },
          enterCredentials: {
            title: 'Anmeldedaten eingeben',
            description:
              'Verwenden Sie Ihren volleymanager-Benutzernamen und Ihr Passwort zur Anmeldung.',
          },
          stayLoggedIn: {
            title: 'Angemeldet bleiben',
            description:
              'Aktivieren Sie "Angemeldet bleiben", um zwischen Sitzungen angemeldet zu bleiben.',
          },
        },
        ...
        tipContent:
          'VolleyKit verwendet dieselben Anmeldedaten wie volleymanager.volleyball.ch. Nutzen Sie die Passwort-Zurücksetzen-Funktion auf der offiziellen Seite, wenn Sie Ihr Passwort vergessen haben.',
      },
    },
    quickTour: {
      title: 'Schnellübersicht',
      description:
        'Nach der Anmeldung sehen Sie das Haupt-Dashboard mit Ihren anstehenden Einsätzen. Hier ist ein kurzer Überblick über die Hauptbereiche:',
      assignments: {
        title: 'Einsätze',
        description:
          'Alle Ihre anstehenden Schiedsrichterspiele anzeigen. Jeder Einsatz zeigt Datum, Uhrzeit, Teams, Spielort und Ihre Rolle (1. Schiedsrichter, 2. Schiedsrichter oder Linienrichter).',
      },
      exchanges: {
        title: 'Tauschbörse',
        description:
          'Verfügbare Spieltausche von anderen Schiedsrichtern durchsuchen oder einen Tausch für einen Ihrer eigenen Einsätze anfordern.',
      },
      compensations: {
        title: 'Vergütungen',
        description:
          'Ihre Schiedsrichterzahlungen und Vergütungshistorie verfolgen. Nach Datum filtern und Daten exportieren.',
      },
      settings: {
        title: 'Einstellungen',
        description:
          'Passen Sie Ihre Erfahrung an, einschliesslich Sprache, Heimatstandort für Reisezeitberechnungen und Benachrichtigungseinstellungen.',
      },
    },
    nextSteps: {
      title: 'Nächste Schritte',
      description:
        'Nachdem Sie nun mit den Grundlagen vertraut sind, erkunden Sie die detaillierten Anleitungen für jede Funktion:',
      links: {
  ...
  assignments: {
    ...
    whatAre: {
      ...
      description:
        'Einsätze sind die Spiele, für die Sie als Schiedsrichter eingeteilt wurden. Jeder Einsatz enthält:',
      details: {
    ...
    viewing: {
      ...
      description:
        'Die Einsatzliste zeigt alle Ihre anstehenden Spiele in chronologischer Reihenfolge. Spiele sind nach Datum gruppiert, damit Sie leicht sehen können, was ansteht.',
    ...
    details: {
      ...
      description:
        'Tippen Sie auf einen Einsatz, um alle Details zu sehen. Die Detailansicht enthält:',
      items: {
    ...
    actions: {
      ...
      description:
        'VolleyKit verwendet Wischgesten für schnellen Zugriff auf Aktionen bei Ihren Einsatzkarten. Je nach Spielstatus stehen Ihnen verschiedene Aktionen zur Verfügung.',
      swipeRight: {
        title: 'Nach rechts wischen – Zur Tauschbörse hinzufügen',
        description:
          'Wischen Sie eine Einsatzkarte nach rechts, um die Tauschaktion anzuzeigen. Wenn Sie ein Spiel nicht wahrnehmen können, können Sie es zur Tauschbörse für andere Schiedsrichter hinzufügen.',
        ...
        warning:
          'Fordern Sie einen Tausch rechtzeitig an. Last-Minute-Anfragen finden möglicherweise keinen Ersatz rechtzeitig.',
      },
      swipeLeft: {
        title: 'Nach links wischen – Validieren & Bearbeiten',
        description:
          'Wischen Sie eine Einsatzkarte nach links, um zusätzliche Aktionen anzuzeigen:',
        validate:
      ...
      directions: {
        ...
        description:
          'Tippen Sie auf eine Einsatzkarte, um sie zu erweitern, und verwenden Sie dann die Wegbeschreibungsschaltfläche, um Ihre bevorzugte Kartenanwendung mit der Route zum Spielort zu öffnen.',
      },
    },
    upcomingPast: {
      ...
      validationClosed:
        'Validierung abgeschlossen – Vergangene Spiele, deren Validierung abgeschlossen ist',
  ...
  exchanges: {
    ...
    whatAre: {
      ...
      description:
        'Ein Tausch ist eine Anfrage von einem Schiedsrichter, der sein geplantes Spiel nicht wahrnehmen kann und einen Ersatz sucht. Das volleymanager-System pflegt eine Tauschbörse, wo Schiedsrichter:',
      features: {
      ...
      infoBox:
        'Tausche werden über das offizielle volleymanager-System verwaltet. VolleyKit bietet eine benutzerfreundlichere Oberfläche für dieselbe Tauschbörse.',
    },
    requesting: {
      title: 'Einen Tausch anfordern',
      description:
        'Wenn Sie eines Ihrer geplanten Spiele nicht wahrnehmen können, können Sie einen Tausch anfordern, um einen Ersatzschiedsrichter zu finden.',
      steps: {
        findAssignment: {
          title: 'Den Einsatz finden',
          description:
            'Gehen Sie zu Ihrem Einsätze-Tab und suchen Sie das Spiel, das Sie tauschen möchten.',
        },
        swipeRight: {
          title: 'Nach rechts auf die Karte wischen',
          description:
            'Wischen Sie die Einsatzkarte nach rechts, um die Tauschaktion anzuzeigen, und tippen Sie darauf. Das Spiel wird in der Tauschbörse veröffentlicht.',
        },
      },
      ...
      warningContent:
        'Je früher Sie einen Tausch anfordern, desto wahrscheinlicher finden Sie einen Ersatz. Last-Minute-Anfragen bleiben oft unbesetzt.',
    },
    viewing: {
      title: 'Verfügbare Tausche anzeigen',
      description:
        'Der Tauschbörse-Tab zeigt alle derzeit zum Tausch verfügbaren Spiele. Dies sind Spiele, die andere Schiedsrichter angeboten haben und für die sie Ersatz suchen.',
      ...
      filtering: {
        ...
        description:
          'Filtern Sie die Tauschliste, um Spiele zu finden, die für Sie passen. Filter werden verfügbar, nachdem Sie die erforderlichen Einstellungen konfiguriert haben:',
        distance:
          'Entfernung – Nach maximaler Entfernung von Ihrem Heimatstandort filtern. Erfordert das Festlegen Ihres Heimatstandorts in den Einstellungen.',
        travelTime:
          'Reisezeit – Nach maximaler Reisezeit mit öffentlichen Verkehrsmitteln filtern. Erfordert sowohl einen Heimatstandort als auch die Aktivierung der ÖV-API in den Einstellungen.',
        usage:
          'Sobald Filter verfügbar sind, erscheinen sie als Umschalt-Chips neben dem Einstellungszahnrad-Symbol. Tippen Sie auf das Zahnrad, um die Maximalwerte für jeden Filter zu konfigurieren.',
    ...
    accepting: {
      ...
      description:
        'Wenn Sie ein Spiel finden, das Sie übernehmen möchten, können Sie den Tausch annehmen:',
      steps: {
        review: {
        ...
        swipeLeft: {
          ...
          description:
            'Wischen Sie die Tauschkarte nach links, um die Übernahmeaktion anzuzeigen, und tippen Sie darauf.',
        },
        confirm: {
    ...
    managing: {
      ...
      description:
        'Sie können Ihre aktiven Tauschanfragen über den Tauschbörse-Tab anzeigen und verwalten. Wenn Sie keinen Tausch mehr benötigen (z.B. Ihr Zeitplan hat sich geändert), können Sie die Anfrage stornieren, bevor jemand sie annimmt.',
      canceling: {
        ...
        steps: {
          ...
          selectAddedByMe:
            'Wählen Sie den Tab "Von mir hinzugefügt", um Ihre ausstehenden Anfragen zu sehen',
          swipeRight:
            'Wischen Sie nach rechts auf die Anfragekarte, um die Entfernen-Aktion anzuzeigen, und tippen Sie darauf',
          confirmCancellation: 'Bestätigen Sie die Stornierung',
        },
        infoBox:
          'Sie können eine Tauschanfrage nur stornieren, wenn sie noch niemand angenommen hat. Nach der Annahme ist der Tausch endgültig.',
      },
    },
  },
  ...
  compensations: {
    ...
    whatAre: {
      ...
      description:
        'Vergütungen sind die Zahlungen, die Sie für das Leiten von Volleyballspielen erhalten. Jeder Vergütungseintrag enthält typischerweise:',
      details: {
      ...
      infoBox:
        'Vergütungsbeträge werden von Swiss Volley festgelegt und variieren je nach Ligastufe und Ihrer Rolle im Spiel.',
    },
    viewing: {
      title: 'Ihre Vergütungen anzeigen',
      description:
        'Die Vergütungsliste zeigt alle Ihre erfassten Zahlungen in chronologischer Reihenfolge. Jeder Eintrag zeigt die wichtigsten Informationen auf einen Blick.',
    ...
    exportPdf: {
      ...
      description:
        'Sie können einzelne Vergütungsdatensätze als PDF-Dokumente exportieren. Wischen Sie nach links auf einer Vergütungskarte, um die PDF-Export-Aktion anzuzeigen.',
      usage:
    ...
    paymentSchedule: {
      title: 'Zahlungsplan',
      description:
        'Vergütungszahlungen werden typischerweise monatlich von Swiss Volley verarbeitet. Der genaue Zahlungsplan kann variieren, aber generell:',
      details: {
      ...
      warning:
        'Stellen Sie sicher, dass Ihre Bankdaten im volleymanager-System aktuell sind, um Zahlungsverzögerungen zu vermeiden.',
    },
  },
  ...
  calendarMode: {
    ...
    whatIs: {
      ...
      description:
        'Der Kalendermodus ist eine leichtgewichtige Nur-Lese-Zugriffsmethode, mit der Sie Ihre anstehenden Einsätze sehen können, ohne Ihr Passwort einzugeben. Er verwendet einen eindeutigen Kalendercode, der mit Ihrem Schiedsrichterkonto verknüpft ist.',
      features: {
    ...
    howToAccess: {
      ...
      description:
        'Um den Kalendermodus zu nutzen, benötigen Sie Ihren eindeutigen Kalendercode aus dem volleymanager-System.',
      steps: {
        findCode: {
          title: 'Ihren Kalendercode finden',
          description:
            'Melden Sie sich bei volleymanager.volleyball.ch an und finden Sie Ihren Kalendercode in Ihren Profileinstellungen.',
        },
        openApp: {
          title: 'VolleyKit öffnen',
        ...
        enterCode: {
          ...
          description:
            'Geben Sie Ihren Kalendercode ein, um auf Ihren Nur-Lese-Spielplan zuzugreifen.',
        },
      },
    ...
    viewingSchedule: {
      ...
      description:
        'Im Kalendermodus sehen Sie Ihre anstehenden Einsätze in einer vereinfachten Ansicht. Die Oberfläche zeigt die wesentlichen Informationen für jedes Spiel.',
    ...
    limitations: {
      ...
      description:
        'Der Kalendermodus ist schreibgeschützt, was bedeutet, dass einige Funktionen nicht verfügbar sind:',
      table: {
        feature: 'Funktion',
      ...
      infoBox:
        'Für Aktionen wie das Bestätigen von Einsätzen oder das Anfordern von Tauschen müssen Sie sich mit Ihren vollständigen Anmeldedaten anmelden.',
    },
    security: {
      title: 'Ihren Code sicher aufbewahren',
      description:
        'Obwohl der Kalendermodus schreibgeschützt ist, sollten Sie Ihren Kalendercode mit Vorsicht behandeln:',
      tips: {
      ...
      warning:
        'Ihr Kalendercode offenbart Ihren vollständigen Spielplan. Teilen Sie ihn nur mit Personen, denen Sie Ihren Aufenthaltsort anvertrauen möchten.',
    },
  },
  ...
  travelTime: {
    ...
    howItWorks: {
      ...
      description:
        'Die Reisezeit-Funktion verwendet die Schweizer ÖV-API (SBB/öV), um Reisezeiten von Ihrem Heimatstandort zu jedem Spielort zu berechnen. Sie berücksichtigt:',
      considerations: {
      ...
      infoBox:
        'Reisezeiten werden mit öffentlichen Verkehrsmitteln berechnet. Wenn Sie normalerweise fahren, nutzen Sie die Zeiten als grobe Schätzung oder zur Planung alternativer Transportmöglichkeiten.',
    },
    settingHome: {
      title: 'Ihren Heimatstandort festlegen',
      description:
        'Um genaue Reisezeiten zu erhalten, müssen Sie Ihren Heimatstandort in den App-Einstellungen festlegen.',
      steps: {
        openSettings: {
        ...
        enterAddress: {
          ...
          description:
            'Geben Sie Ihre Heimadresse oder die Station ein, von der Sie normalerweise reisen.',
        },
        saveSettings: {
    ...
    viewingTimes: {
      ...
      description:
        'Sobald Ihr Heimatstandort festgelegt ist, erscheinen Reisezeiten auf Ihren Einsatzkarten und in der Einsatzdetailansicht.',
    ...
    journeyDetails: {
      ...
      sbbLink:
        'Sie können die Reise auch direkt in der SBB-App oder Website öffnen für Echtzeit-Updates und Ticketkauf.',
    ...
    arrivalBuffer: {
      ...
      description:
        'Die vorgeschlagene Abfahrtszeit enthält einen Puffer, um sicherzustellen, dass Sie vor Spielbeginn ankommen:',
      details: {
      ...
      warning:
        'Planen Sie immer zusätzliche Zeit für wichtige Spiele oder unbekannte Spielorte ein. Öffentliche Verkehrsmittel können unerwartete Verspätungen haben.',
    },
    offlineAvailability: {
      title: 'Offline-Verfügbarkeit',
      description:
        'Reisezeiten werden zwischengespeichert, wenn Sie sie online anzeigen. Wenn Sie offline sind:',
      details: {
  ...
  offlinePwa: {
    ...
    whatIsPwa: {
      ...
      description:
        'Eine Progressive Web App ist eine Website, die wie eine native App funktioniert. Wenn Sie VolleyKit installieren:',
      benefits: {
    ...
    installing: {
      ...
      description:
        'Sie können VolleyKit auf jedem modernen Gerät installieren – Handys, Tablets oder Computer.',
      ios: {
        ...
        steps: {
          ...
          confirmInstall: {
            ...
            description:
              'Tippen Sie auf "Hinzufügen", um VolleyKit auf Ihrem Startbildschirm zu installieren.',
          },
        },
      },
      android: {
        ...
        steps: {
          ...
          lookForPrompt: {
            ...
            description:
              'Ein Banner oder eine Aufforderung sollte erscheinen, um die App zu installieren.',
          },
          tapInstall: {
      ...
      desktop: {
        ...
        description:
          'Suchen Sie nach dem Installationssymbol in der Adressleiste (normalerweise ein + oder Computersymbol) oder verwenden Sie das Browsermenü, um "VolleyKit installieren" zu finden.',
      },
    },
    whatWorksOffline: {
      title: 'Was offline funktioniert',
      description:
        'Wenn Sie offline sind, können Sie weiterhin auf zuvor angesehene Inhalte zugreifen:',
      table: {
        feature: 'Funktion',
        offline: 'Offline',
        notes: 'Hinweise',
      ...
      infoBox:
        'Die App synchronisiert automatisch, wenn Sie wieder online sind. Alle Datenänderungen werden abgerufen und angezeigt.',
    },
    offlineIndicator: {
      title: 'Offline-Anzeige',
      description:
        'Wenn Sie offline sind, zeigt VolleyKit eine visuelle Anzeige, damit Sie wissen, dass Sie zwischengespeicherte Daten sehen. Achten Sie auf das Offline-Abzeichen im Header oder ein Banner am oberen Bildschirmrand.',
    ...
    updating: {
      ...
      description:
        'VolleyKit aktualisiert sich automatisch im Hintergrund. Wenn eine neue Version verfügbar ist:',
      steps: {
    ...
    storage: {
      ...
      description:
        'VolleyKit verwendet minimalen Speicher auf Ihrem Gerät – typischerweise weniger als 5MB für die App selbst plus zwischengespeicherte Daten. Sie können den Cache bei Bedarf in Ihren Browsereinstellungen löschen.',
      warning:
        'Das Löschen von Browserdaten oder "Cache leeren" entfernt Ihre Offline-Daten. Sie müssen möglicherweise Einsätze beim nächsten Öffnen der App neu laden.',
    },
  },
  ...
  settings: {
    ...
    accessing: {
      ...
      description:
        'Öffnen Sie die Einstellungen durch Tippen auf das Zahnradsymbol in der Navigationsleiste oder durch Auswählen von "Einstellungen" im Hauptmenü.',
    ...
    profile: {
      ...
      infoBox:
        'Profilinformationen stammen aus volleymanager und können nur auf der offiziellen Website geändert werden, nicht in VolleyKit.',
      loggingOut: {
        title: 'Abmelden',
        description:
          'Tippen Sie auf "Abmelden", um sich von Ihrem Konto abzumelden. Dies löscht Ihre Sitzung und alle lokal gespeicherten Daten.',
      },
    },
    language: {
      ...
      autoDetect:
        'Die App verwendet automatisch die Sprache Ihres Browsers, wenn sie unterstützt wird, aber Sie können dies in den Einstellungen überschreiben.',
    ...
    homeLocation: {
      ...
      description:
        'Legen Sie Ihren Heimatstandort fest, um Reisezeitberechnungen zu aktivieren. Dies wird verwendet, um zu zeigen, wie lange Sie brauchen, um jeden Spielort zu erreichen.',
      instructions: {
    ...
    dataPrivacy: {
      ...
      localStorage: {
        ...
        description:
          'VolleyKit speichert Daten lokal, um Offline-Zugriff zu ermöglichen und die Leistung zu verbessern:',
        items: {
      ...
      clearData: {
        ...
        description:
          'Sie können alle lokal gespeicherten Daten von der Einstellungsseite löschen. Dies wird:',
        effects: {
        ...
        warning:
          'Das Löschen lokaler Daten kann nicht rückgängig gemacht werden. Sie müssen Ihre Einsätze beim nächsten Öffnen der App neu laden.',
      },
